import { SELLERS, deriveUnderwritingInputs, seededBacktestSellers } from "./lib/data/seed";
import { aggregatePerceivedMargin, aggregateTrueMargin, perSkuMargins } from "./lib/domain/margin-engine";
import { trueMarginModel } from "./lib/domain/underwriting";
import { runBacktest } from "./lib/domain/backtest";
import { InMemoryLedger, recordDecision } from "./lib/domain/ledger";
