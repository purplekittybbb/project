...
import type { Currency, UnderwritingDecision, UnderwritingInputs } from "./canonical.js";
import { incumbentModel, trueMarginModel } from "./underwriting.js";
 ...
 */
function simulateOutcome(decision: UnderwritingDecision): LoanOutcome {
